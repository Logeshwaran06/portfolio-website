...
export default function App() {
  ...
  const skills = ["HTML", "CSS", "JavaScript", "React", "Node JS", "Express JS", "MongoDB", "Python", "Machine Learning"];
    ...
    <>
      ...
      <div className='header'>
        ...
        <ul className='contactList'>
          ...
          <li className='contactInfo'><a className='colors' href="https://github.com/Logeshwaran06"><icon className='icons accentColor gitHub'>WhatsApp</icon></a></li>
        </ul>
        ...
        <div className='project'>
          {projectDetails.map((project, index) => (
            <div key={index} className="projectDiv divBorder">
              ...
              <a className="projectLink colors accentColor" href='#'>{project.viewProject}</a>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="footer-container">
          ...
          <div className="footer-social">
            ...
            <div className="social-icons">  
              ...
              <a className='colors accentColor' href="https://www.linkedin.com/in/logeshmohan" target="_blank"><icon className="fab fa-linkedin">WhatsApp</icon></a>
            </div>
          </div>      
        </div>
